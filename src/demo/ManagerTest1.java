...
class Employee {
	...
	public String toString(){
		return "Employee.... is "+name+"salary is..."+salary;
	}
}
...
class Manager extends Employee {
	...
	public String toString(){
		return "Manager is saalry is"+getSalary();
	}
...
public class ManagerTest1 {
	...
	public static void main(String[] args) {
		Manager boss1 = new Manager("Boss Guy", 80000, 2009, 12, 15);
		boss1.setBonus(999.99);
		...
		Manager boss3=(Manager)boss;
		boss3.setBonus(999.222);
